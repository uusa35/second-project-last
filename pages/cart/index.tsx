...
const CartIndex: NextPage = (): JSX.Element => {
  ...
  return (
    <MainContentLayout>
      ...
      <div>
        {/* if cart is empty */}
          <div className='flex justify-center py-5'>
            <p suppressHydrationWarning={suppressText}>{t('your_cart_is_empty')}</p>
          </div>

          <div>
            <p className="mx-7 text-lg" suppressHydrationWarning={suppressText}>{t("items")}</p>
            <div className=" pt-5">
      ...
      <div className="px-5">
        <div className="flex items-center">
          <Image 
            ...
            suppressHydrationWarning={suppressText}
          />
          <p className='font-semibold ps-2' suppressHydrationWarning={suppressText}>
            {t("promotion_code")}
          </p>
        </div>
      ...
      <div
        className="mt-10 px-5 py-7 bg-gray-100"
      >
        <div>
