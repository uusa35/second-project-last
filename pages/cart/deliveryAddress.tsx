...
const DeliveyAddress: NextPage = (): JSX.Element => {
                        ...
                        >
                            ...
                            >
                                <div className='flex items-center justify-center'>
                                    ...
                                    <p className='px-2' suppressHydrationWarning={suppressText}>{t('home')}</p>
                                </div>
                            </a>
                            </li>
                            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                            ...
                            >
                                <div className='flex items-center justify-center'>
                                    <Image src={openTab===2? ApartmentAcitveIcon: ApartmentIcon} alt='icon' width={20} height={20}/>
                                    <p className='px-2' suppressHydrationWarning={suppressText}>{t('appartment')}</p>
                                </div>
                            </a>
                            </li>
                            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
                            ...
                            >
                                <div className='flex items-center justify-center'>
                                    <Image src={openTab===3? OfficeAcitveIcon: OfficeIcon} alt='icon' width={20} height={20}/>
                                    <p className='px-2' suppressHydrationWarning={suppressText}>{t('office')}</p>
                                </div>
                            </a>
                            </li>
                        </ul>
                        ...
                        <div className="relative flex flex-col">
                            <div className="flex-auto">
                                <div className="tab-content tab-space">
                                    ...
                                    <div className={openTab === 2 ? "block" : "hidden"} id="apartment">
                                        <input
                                            type="text"
                                            className={`${addressInputField}`}
                                            suppressHydrationWarning={suppressText}
                                    ...
                                    <div className={openTab === 3 ? "block" : "hidden"} id="office">
                                    <input
                                        type="text"
                ...
                <div className="mx-4">
                    <p className="my-5 font-semibold text-base">{t("delivery_prefrences")}</p>
                        <div className="flex items-center mb-4">
                            ...
                            <label htmlFor="deliverNow" className="ms-2 font-medium text-gray-900 dark:text-gray-300" 
                            suppressHydrationWarning={suppressText}>{t('deliver_now')}</label>
                        </div>
                        <div className="flex items-center mb-4">
                            <input id="deliverLater" type="radio" name="deliver" value="" className="w-8 h-8 text-blue-600 bg-gray-100 border-gray-300 
                            ...
                            <label htmlFor="deliverLater" className="ms-2 font-medium text-gray-900 dark:text-gray-300" 
                            suppressHydrationWarning={suppressText}>
                                {t('deliver_later')}</label>
                        </div>
                    {show && (
                    <div>
